...
void Test::Draw( std::wostream& stream)
{
	stream << L"Test";
}
...
void Test::Load(std::wistream& is)
{
	std::wstring wline;
	std::getline(is, wline, L'\n');
	...
	do
	{
		...
		{
			m_results_desc = loadTag(is, L"</results>");
		}
...
void Test::Load(const std::string& fname)
{
